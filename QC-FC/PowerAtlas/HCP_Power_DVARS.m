...
%SubList={'172029','123117','117122'};
%SubList={'151526','187345','303624','132118','901139','171330','263436','191336','779370','195041','145127','172029'};
%SubList={'100307','103414','105115','111312','113619','115320','117122','118730','123117'};
...
for s=SubList
    ...
    load(['R/ts/HCP_MinimalF_' s{1} '_Power_ts.mat'],'ats')
    %ats=ats(150,:);
    %----------------------------------------------------------    
    [DVARS,DVARS_Stat]  = DVARSCalc(ats','Scale',scl,'verbose',0);
    dv_rmv0             = find(DVARS_Stat.pvals<(0.05./1199));
    dv_rmv              = dv_rmv0(ismember(dv_rmv0,find(DVARS_Stat.DeltapDvar>=5)));
...
%     [FDts,FD_Stat]=FDCalc(MovPar,[0 0 0 1 1 1],50,0);
    ...
    %----------------------------------------------------------
    load(['R/mts/HCP_MinimalF_' s{1} '_Power_ROIs.mat'],'mts','ROI')
    %----------------------------------------------------------
    for r0=1:264
        c0=mean(ROI.XYZ{r0});
        for r1=1:264
    ...
    rgs_key = unique([dv_rmv dv_rmv+1]);%unique([dv_rmv]);
    ...
    dvQthr_rmv=DumbDVARSQFilt(DVARS);
...
%----------------------------------------------------------    
    ...
    save(['R/NetMats/HCP_MinimalF_' s{1} '_Power_NetMats_DVC.mat'],'mat_dvs_scrmbld','rgs_key','mat_dv_Qthr','dvQthr_rmv','dvthr_rmv','rgsDM','V_DVC','DSE_Stat_DVC','DVARS_DVC','DVARS_Stat_DVC','thr_fd_con','thr_fd_lib','V_DVC_reg','DSE_Stat_DVC_reg','DVARS_DVC_reg','DVARS_Stat_DVC_reg','mat','mat_dvr','mat_dvs','mat_dv_thr','mat_fd_lib','fd_rmv_dp_lib','fd_rmv_lib','mat_fd_con','fd_rmv_dp_con','fd_rmv_con','dv_rmv','DVARS','DVARS_Stat','FDts','FD_Stat','ED','DSE_Stat','V','conNlib','conDlib')
...
%     end
 ...
 %---------------------------------    
    export_fig(hh0,['DVARSplots/DVARS_plots_' s{1} '.pdf'])
