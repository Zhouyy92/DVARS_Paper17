...
%   Z_s2m_Dh = Zstat(DVARS2,M_DV2,S_DV2);
%   P_Z_s2m_Dh = Zp(DVARS2,M_DV2,S_DV2);
%   P_s2m_Dh = X2p(DVARS2,M_DV2,S_DV2);
% 
%   M_DV2 = Mn(2);             % Mean of voxelwise sig2
%   S_DV2 = sqrt(Va(2));       % half-IQR of DVARS2
%   P_s2b_Dh = X2p(DVARS2,M_DV2,S_DV2);
%   Z_s2b_Dh = Zstat(DVARS2,M_DV2,S_DV2);
%   P_Z_s2b_Dh = Zp(DVARS2,M_DV2,S_DV2);
% 
%   M_DV2 = Mn(5);             % Median of DVARS2
%   S_DV2 = sqrt(Va(2));       % half-IQR of DVARS2
%   P_Dm_Dh = X2p(DVARS2,M_DV2,S_DV2);
%   Z_Dm_Dh = Zstat(DVARS2,M_DV2,S_DV2);
%   P_Z_Dm_Dh = Zp(DVARS2,M_DV2,S_DV2);
% 
% 
%   Pval(r,:,:) = [P_s2m_Dh;P_Z_s2m_Dh;P_s2b_Dh;P_Z_s2b_Dh;P_Dm_Dh;P_Z_Dm_Dh];
% 
%   ZStat(r,:,:) = [Z_s2m_Dh;Z_s2b_Dh;Z_Dm_Dh];
% 
%   for i=1:length(RRalpha)
%     RR(r,i,:)=mean(Pval(r,:,:)<=RRalpha(i),3);
%   end
